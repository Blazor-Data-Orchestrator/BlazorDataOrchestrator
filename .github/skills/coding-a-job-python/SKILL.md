        ...
        try:
            ...
            with urllib.request.urlopen(req, timeout=30) as response:
                ...
                try:
                    ...
                    weather_info = f"90746 - Temperature: {temp_f}°F ({temp_c}°C), Humidity: {humidity}%, Conditions: {weather_desc}"
                    print(weather_info)
...
## 3. Execution Logic (`OnRunCode`)

The C# harness creates a temporary `runner.py` that imports your `main.py` and calls `execute_job`. Understanding this flow is crucial to ensuring your method signature remains compatible.
