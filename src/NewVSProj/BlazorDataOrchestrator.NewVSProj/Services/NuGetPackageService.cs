...
namespace BlazorDataOrchestrator.NewVSProj.Services
{
    /// <summary>
    ...
    /// environment-specific functionality for the NewVSProj.
    /// </summary>
    public class NuGetPackageService
    {
        ...
        {
            var projectFile = Path.Combine(_environment.ContentRootPath, "BlazorDataOrchestrator.NewVSProj.csproj");
