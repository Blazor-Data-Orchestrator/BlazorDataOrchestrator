...
namespace BlazorDataOrchestrator.TestJobOnline.Services
{
    /// <summary>
    ...
    /// environment-specific functionality for the TestJobOnline.
    /// </summary>
    public class NuGetPackageService
    {
        ...
        {
            var projectFile = Path.Combine(_environment.ContentRootPath, "BlazorDataOrchestrator.TestJobOnline.csproj");
