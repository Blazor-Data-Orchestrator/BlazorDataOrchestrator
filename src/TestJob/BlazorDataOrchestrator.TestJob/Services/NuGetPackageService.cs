...
namespace BlazorDataOrchestrator.TestJob.Services
{
    /// <summary>
    ...
    /// environment-specific functionality for the TestJob.
    /// </summary>
    public class NuGetPackageService
    {
        ...
        {
            var projectFile = Path.Combine(_environment.ContentRootPath, "BlazorDataOrchestrator.TestJob.csproj");
